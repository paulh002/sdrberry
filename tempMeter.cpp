...
{
	lv_scale_set_range(meter, startvalue, endvalue);
}
...
void tempMeter::set_indicator(int32_t value)
{
	...
	lv_scale_set_line_needle_value(meter, needle, 60 ,value / 1000);
