...
const int			default_block_length = 65536;
linear_ringbuffer	rbuffer(default_block_length * sizeof(complex<float>));
...
int main(int argc, char *argv[])
{
	...
	*/
	...
	{	
		...
		create_rx_streaming_thread(&soapy_devices[0], &vfo_setting, ifrate);
		...
		create_fm_thread(ifrate, tuner_offset, pcmrate, true, bandwidth_pcm, downsample, audio_output);
		set_vol_slider(50);
