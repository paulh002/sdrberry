...
public:
	...
	SoapySDR::Range get_full_frequency_range(std::string name, int chan) {return SdrDevices[name]->rx_channels[chan]->get_full_frequency_range() ;}
	SoapySDR::RangeList get_full_frequency_range_list(std::string name, int chan) {return SdrDevices[name]->rx_channels[chan]->get_full_frequency_range_list() ;}
