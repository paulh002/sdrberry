 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(FreeSansOblique42); LV_FONT_DECLARE(FreeSansOblique32);
...
#define LV_USE_WAYLAND          1
    ...
    #define LV_WAYLAND_USE_DMABUF           0    /**< Use DMA buffers for frame buffers. Requires LV_DRAW_USE_G2D */ /*LV_DISPLAY_RENDER_MODE_PARTIAL*/
