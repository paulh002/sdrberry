...
{
public:
	void init(double ifrate, double tuner_offset, int pcmrate, bool stereo, double bandwidth_pcm, unsigned int downsample, AudioOutput *audio_output);
	~FmDecoder_executer();
...
void create_fm_thread(double ifrate, double tuner_offset, int pcmrate, bool stereo, double bandwidth_pcm, unsigned int downsample,  AudioOutput *audio_outputint);
