...
const cfg::File::ConfigMap defaultOptions = {
	...
	{"radioberry", {{"gain", cfg::makeOption(10)}, {"drive", cfg::makeOption(89)}, {"if-gain", cfg::makeOption(40)}, {"samplerate", cfg::makeOption("384")}, {"samplerate_tx", cfg::makeOption("48")}, {"AGC", cfg::makeOption("off")}, {"span", cfg::makeOption(96)}, {"audiobuffer", cfg::makeOption(4096)}, {"thresholdDroppedFrames", cfg::makeOption(40)}, {"thresholdUnderrun", cfg::makeOption(2)}, {"correction_tx", cfg::makeOption(0)}, {"correction_rx", cfg::makeOption(0)}, {"buffersize", cfg::makeOption(1008)}}},
