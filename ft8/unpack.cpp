...
unpack_4(int a77[])
{
  ...
  long long n58 = (uint64_t)un(a77, 12, 58);
  char call[16];
  for(int i = 0; i < 11; i++){
    call[10-i] = chars[n58 % 38];
    n58 = n58 / 38;
  ...
  if ((uint64_t)un(a77, 73, 1) == 1){
    return std::string("CQ ") + call;
  }

  int x12 = (uint64_t)un(a77, 0, 12);
  // 12-bit hash
  hashes_mu.lock();
  std::string ocall;
  if(hashes12.count(x12) > 0){
  ...
  int suffix = (uint64_t)un(a77, 71, 2);
  if(suffix == 1){
    msg += " RRR";
  } else if(suffix == 2){
    msg += " RR73";
...
unpack_1(int a77[])
{
  ...
  int i = 0;
  int call1 = (uint64_t)un(a77, i, 28);
  i += 28;
  int rover1 = a77[i];
  i += 1;
  int call2 = (uint64_t)un(a77, i, 28);
  i += 28;
  int rover2 = a77[i];
  i += 1;
  int ir = a77[i];
  i += 1;
  int grid = (uint64_t)un(a77, i, 15);
  i += 15;
  int i3 = (uint64_t)un(a77, i, 3);
  i += 3;
  assert((i3 == 1 || i3 == 2) && i == 77);
...
unpack_0_0(int a77[])
{
  // the 42 possible characters.
  const char *cc = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ+-./?";
  Int128 x = un(a77, 0, 71);
  std::string msg = "0123456789123";
  for(int i = 0; i < 13; i++){
    msg[13-1-i] = cc[uint32_t(x % Int128{42})];
	x = x / Int128{42};
  }
  return msg;
}
...
unpack_3(int a77[])
{
  ...
  int r = a77[i];
  i += 1;
  int rst = (uint64_t)un(a77, i, 3);
  i += 3;
  int serial = (uint64_t)un(a77, i, 13);
  i += 13;
...
unpack_0_3(int a77[], int n3)
{
  ...
  int call2 = (uint64_t)un(a77, i, 28);
  i += 28;
  int R = (uint64_t)un(a77, i, 1);
  i += 1;
  int n_transmitters = (uint64_t)un(a77, i, 4);
  if(n3 == 4)
    n_transmitters += 16;
  i += 4;
  int clss = (uint64_t)un(a77, i, 3); // class
  i += 3;
  int section = (uint64_t)un(a77, i, 7); // ARRL section
  i += 7;
...
unpack(int a77[])
{
	int i3 = (uint64_t)un(a77, 74, 3);
	int n3 = (uint64_t)un(a77, 71, 3);
